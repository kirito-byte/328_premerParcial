...
<body>
    <header>
        ...
        <div id="nav">
            <nav>
                <ul>
                    <li>
                        <a href="./fisica/fisica.php">Fisica</a>
                    </li>
                    <li>
                        <a href="./matematica/mat.php">Matematica</a>
                    </li>
                    <li>
                        <a href="./quimica/quimica.php">Quimica</a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <main>
        <section class="principal">
            ...
            <article>
                Esta Facultad tiene varias carreras
            </article>
        </section>
        <?php
            include './conx/footer.php'
        ?>
